	...
	const plans = [
		{
			...
			price: 0,
			isMostPop: false,
			features: ["300 traductions par jour", "Traduction en temps réel", "Suivi des traductions", "1 utilisateur", "Support technique", "Accès à la documentation"],
		},
		{
			name: "Starter",
			...
			price: 12,
			isMostPop: true,
			features: ["5000 traductions par jour", "Personnalisation des traductions", "Statistiques avancées", "Gestion des utilisateurs", "5 utilisateurs", "Support technique"],
		},
		{
			name: "Business",
			...
			price: 32,
			isMostPop: false,
			features: ["Traductions illimitées", "Personnalisation des traductions", "Statistiques avancées", "IA personnalisée", "Utilisateurs illimités", "Support personnalisé"],
		},
	]
	...
	return (
		<SectionWrapper id="pricing" className="custom-screen">
			<div className="relative max-w-xl mx-auto text-center">
				<h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">Choisissez l'offre qui vous convient</h2>
			</div>
			<LayoutEffect
								...
								<div className="pt-8">
									<Button
										...
										className={`w-full rounded-full text-white ring-offset-2 focus:ring ${
											item.isMostPop ? "bg-purple-600 hover:bg-purple-500 focus:bg-purple-700 ring-purple-600" : "bg-gray-800 hover:bg-gray-700 ring-gray-800"
										}`}
									>
										Commencer
									</Button>
