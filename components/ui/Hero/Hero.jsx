			...
			>
				<div>
					<div className="space-y-5 max-w-3xl mx-auto text-center">
						...
						>
							L'outil de traduction de langue des signes alimenté par l'IA
						</h1>
						<p className="max-w-xl mx-auto text-gray-300">Gagnez le contrôle de toutes les situations et facilitez l'intégration des personnes sourdes et malentendantes</p>
